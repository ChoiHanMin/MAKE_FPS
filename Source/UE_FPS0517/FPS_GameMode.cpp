...
{
	static ConstructorHelpers::FClassFinder<AFPS_Controller> PC_Class(TEXT("Blueprint'/Game/BluewPrints/FPS_Controller.FPS_Controller_C'"));
	...
	static ConstructorHelpers::FClassFinder<AFPS_Controller> Pawn_Class(TEXT("Blueprint'/Game/BluewPrints/FPS_Character.FPS_Character_C'"));
